---
layout: post
title:  "Self-study: CMU Probabilistic Graphical Models 10-708 Spring 2019 materials. "
date:   2021-06-08 03:00:00 +0100
categories: jekyll update
katex: True
---

**This page is intended as a resource for those wishing to self-study the graduate-level course “Probabilistic Graphical Models”, taught by Eric Xing to MS/MSc and PhD students in machine learning at Carnegie Mellon University in the spring of 2019. It contains all publically available course materials from the official course page, work I completed as part of my own self-study; as well as my own comments and materials for those who wish to similarly benefit.**

**At the time of publishing, some uploads are still pending, to be completed.**

The original source from which all publically available course materials have been extracted is the following course page:
...
For those wishing to use the materials from this course for self-study, the utility of this particular spring 2019 iteration is that there is a complete set of publically available recorded video lectures, and also a complete set of homework assignments.

In order to faciliate the use of the course materials for those self-studying, I have based this page on the original course page as faithfully as possible. I have endeavoured to keep my own comments to a minimum, at least in the first part of the page.
...
As someone undertaking a programme of self-study in machine learning using CMU publically available materials, this course was one of the more technically challenging, but also more rewarding courses.
...
Firstly, on the relevance of graphical models for machine learning, the following is a quotation by Michael Jordan, from [a page on Kevin Murphy's website](https://www.cs.ubc.ca/~murphyk/Bayes/bnintro.html), both of whom are authors of textbooks used on the course:
...
[Koller, D., Friedman, N. (2009) *Probabilstic Graphical Models: Principles and Techniques.* MIT Press.](https://uk.bookshop.org/a/7712/9780262013192)

<p align="center">
  <a href="https://uk.bookshop.org/a/7712/9780262013192">
    <img src="/assets/2021-06-08-self-study-10-708/PGMPT.jpg">
  </a>
</p>
...
Chapters from Michael Jordan's draft textbook are freely available at his homepage, and individual chapters prescribed to accompany each lecture are in course schedule below. All the chapters of the book can also be found and downloaded in their entirety [in this subdirectory](https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/tree/master/readings/intro-to-pgms-book-jordan) of my GitHub repo.
...
Lecture slides, instrutctor-annotated lecture slides, publically available YouTube lecture recordings, scribed course notes and readings are linked in the course schedule below.

|   Date.	|   Lectures.	|   Readings.	|
|---	|---	|---	|
|   1/14	|   Lecture #1 (Eric): <br> **Introduction to GM.** <br> [[slides][L1a] ([annotated][L1b]) \| [video][L1c] \| [notes][L1d]]	|   - Jordan, [Graphical Models][L1r1]. <br>- E. Airoldi, [Getting Started in Probabilistic Graphical Models][L1r2]. <br> 	|
...
|   1/23	|   Lecture #3 (Eric):<br> **Representation: Undirected GMs (MRFs).**<br> [[slides][L3a] ([annotated][L3b]) \| [video][L3c] \| [notes][L3d]]	|   - Jordan textbook, [Ch. 2][L3r1]. (Sec. 2.2 - end). <br>- Koller and Friedman textbook, [Ch. 4][L3r2]. <br> - A. Fischer and C. Igel. [An Introducton to Restricted Boltzmann Machines][L3r3]. <br>	|
|   1/28 <br> HW1 out.	|   Lecture #4 (Eric): <br> **Exact inference.** <br>- Elimination. <br>- Message passing.<br>- Sum product algorithm. <br> [[slides][L4a] ([annotated][L4b]) \| [video][L4c] \| [notes][L4d]]	|   - Jordan textbook, [Ch. 3][L4r1] and [Ch. 4][L4r2] <br>- Koller and Friedman textbook, [Ch. 9][L4r3], [Ch. 10][L4r4]. <br>- Minka, [Divergence measures and message passing][L4r5]. <br>	|
|   1/30	|   Lecture #5 (skipped): <br> **Parameter learning in fully observable Bayesian Networks.** <br> - Generalized Linear Models (GLIMs) <br>- Maximum Likelihood Estimation (MLE) <br>- Markov Models. <br> [[slides][L5a] \| [notes][L5d]]	|   - Jordan textbook, [Ch. 8][L5r1], [Ch. 9][L5r2] (Sec. 9.1 - 9.2). <br> - Koller and Friedman textbook, [Ch. 17][L5r3] (Sections 17.1 - 17.4). <br> - Geiger and Heckerman. [Parameter priors for directed acyclic graphical models and the characterization of several probability distributions][L5r4]. <br> -Geiger and Heckerman. [A characterization of the Dirichlet distribution through global and local parameter independence][L5r5].<br>	|
|   2/4	|   Lecture #6 (Maruan): <br> **Parameter Learning of partially observed BNs.** <br>- Mixture models.  <br>- Hidden Markov Models (HMMs). <br>- The EM algorithm. <br> [[slides][L6a] ([annotated][L6b]) \| [video][L6c] \| [notes][L6d]]	|   - Jordan textbook, [Ch. 11][L6r1]. <br>- Koller and Friedman textbook, [Ch. 19.1-19.4.][L6r2] <br>- Borman. [The EM algorithm (A short tutorial)][L6r3]. <br>- Neal and Hinton. [Some interesting aspects of the EM algorithm][L6r4]. <br>	|
|   2/6	|   Lecture #7 (Eric): <br> **Maximum likelihood learning of undirected GM.** <br> [[slides][L7a] ([annotated][L7b]) \| [video][L7c] \| [notes][L7d]]	|   - Jordan textbook, [Ch. 9][L7r1] (Sec. 9.3-9.5), [Ch. 20][L7r2]. <br>- Friedman, Hastie, Tibshirani. [Sparse inverse covariance estimation with the graphical lasso][L7r3]. <br>- Lafferty et al. [Conditional Random Fields - Probabilistic Models for Segmenting and Labeling Sequence Data][L7r4]. <br>	|
|   2/11	|   Lecture #8 (guest lecture, Kun Zhang @ Department of Philosophy): <br> **Causal discovery and inference.** <br> [[slides][L8a] \| [video][L8c] \| [notes][L8d]]|   - J. Pearl, M. Glymour, and N. P. Jewell. [Causal Inference in Statistics A Primer][L8r1].  <br>- P. Spirtes, C. Glymour, and R. Scheines. [Causation, Prediction, and Search][L8r2]. Pages 80-89 and 125-123-136. Traditional methods for causal discovery, including the PC and FCI algorithms. <br>- K. Zhang, B. Schöklopf, P. Spirtes, and C. Glymour. [Learning causality and causality-related learning. Brief review of recent methods for causal discovery][L8r3]. <br>	|
|   2/13 <br> HW1 due.	|   Lecture #9 (Eric): <br> **Modeling networks.** <br>- Gaussian graphical models. <br>- Ising models. <br> [[slides][L9a] ([annotated][L9b]) \| [video][L9c] \| [notes][L9d]]	|   - Meinshausen and Buhlmann. [High-Dimensional Graphs and Variable Selection with the Lasso][L9r1]. <br>- Kolar et al., Estimating Time-Varying Networks. <br>- Dempster. [Covariance Selection][L9r2]. <br>	|
|   2/18	|   Lecture #10 (Eric): <br> **Sequential models.** <br>- Discrete Hidden State (HMM vs. CRF). <br> - Continuous Hidden State (Kalman Filter). <br> [[slides][L10a] ([annotated][L10b]) \| [video][L10c] \| [notes][L10d]]	|   - Jordan textbook, ]Ch. 14][L10r1], [Ch. 15][L10r2]. <br>- Ng, [Lecture notes on factor analysis][L10r3]. <br>- Welch and Bishop. [An Introduction to the Kalman Filter][L10r4]. <br>- Wallach. [Conditional Random Fields - An Introduction][L10r5]. <br>	|
|   2/20 <br> HW2 out.	|   Lecture #11 (Eric): <br> **Approximate Inference: Mean Field (MF) and loopy Belief Propagation (BP) approximations.** <br> [[slides][L11a] ([annotated][L11b]) \| [video][L11c] \| [notes][L11d]]	|   - Yedidia et al. [Generalized Belief Propagation][L11r1]. <br>- Xing et al. [A Generalized Mean Field Algorithm for Variational Inference in Exponential Families][L11r2]. <br>- Mohamed et al. [Variational inference tutorial (NIPS 2016)][L11r3]. <br>	|
|   2/25	|   Lecture #12 (Eric): <br> **Theory of Variational Inference: Inner and Outer Approximations.** <br> [[slides][L12a] ([annotated][L12b]) \| [video][L12c] \| [notes][L12d]]	|   - Wainwright and Jordan. [Variational Inference in Graphical Models - The View from the Marginal Polytope][L12r1]. <br>- Wainwright and Jordan. [Graphical Models, Exponential Families, and Variational Inference][L12r2] (Sec. 3 and 4). <br>	|
|   2/27	|   Lecture #13 (Eric): <br> **Approximate Inference: Monte Carlo and Sequential Monte Carlo methods.** <br> [[slides][L13a] ([annotated][L13b]) \| [video][L13c] \| [notes][L13d]]	|   - Jordan textbook, [Ch. 21][L13r1]. <br>- David MacKay's Textbook, [Ch. 29][L13r2] (Sec. 29.1-29.3). <br>	|
|   3/4	|   Lecture #14 (Eric): <br> **Markov Chain Monte Carlo.** <br>- Metropolis-Hastings. <br>- Hamiltonian Monte Carlo. <br>- Langevin Dynamics. <br> [[slides][L14a] ([annotated][L14b]) \| [video][L14c] \| [notes][L14d]]	|   - David MacKay's Textbook, [Ch. 29][L14r1] (Sec. 29.4-29.10). <br>- Neal. [MCMC using Hamiltonian dynamics][L14r2]. <br>- Patterson and Teh. [Stochastic Gradient Riemannian Langevin Dynamics on the Probability Simplex][L14r3]. <br>	|
|   3/6 <br> HW2 due.	|   Lecture #15 (Eric): <br> **Statistical and Algorithmic Foundations of Deep Learning.** <br>- Insight into DL. <br>- Connections to GM. <br> [[slides][L15a] ([annotated][L15b]) \| [video][L15c] \| [notes][L15d]]	|   - Deep learning book, [Ch. 6.2-5][L15r1], [20.3-4][L15r2]. <br>- Salakhutdinov and Hinton. [Deep Boltzmann machines][L15r3]. <br>- Belanger and McCallum. [Structured prediction energy networks][L15r4]. <br>- Ranganath et al. [Deep exponential families][L15r5]. <br>	|
|   3/11	|   No class (Spring Break).	|   	|
|   3/13	|   No class (Spring Break).	|   	|
|   3/18 <br> HW3 out.	|   Lecture #16 (guest lecture, Zhiting Hu): <br>**Building blocks of DL.** <br>- RNN and LSTM. <br>- CNN, Transformers. <br>- Attention mechanisms. <br>- (Case studies in NLP). <br> [[slides][L16a] \| [video][L16c] \| [notes][L16d]]	|   - Pascanu, Mikolov, Bengio. [On the difficulty of training recurrent neural networks][L16r1]. <br>- Vasvani et al. [Attention is all you need][L16r2]. <br>- Devlin et al. [BERT - Pre-training of Deep Bidirectional Transformers for Language Understanding][L16r3]. <br>	|
|   3/20	|   Lecture #17 (Eric): <br> **Deep generative models (part 1)**\: <br>**Overview of the theoretical basis and connections of deep generative models.**<br>- Wake sleep algorithm. <br>- Variational autoencoders. <br>- Generative adversarial networks. <br>- A unified view of DGM. <br> [[slides][L17a] \| [video][L17c] \| [notes][L17d]]	|   - Deep learning book, [Ch. 20.9-10][L17r1]. <br>- Kingma and Welling. [Variational auto-encoders][L17r2]. <br>- Goodfellow et al. [Generative Adversarial Nets][L17r3].  <br>- Sanjeev Arora. [GANs, some open questions (blog)][L17r4]. <br>	|
|   3/25	|   Lecture #18 (guest lecture, Zhiting Hu): <br> **Deep generative models (part 2).** <br>- GANs and their variations. <br>- Normalizing Flows. <br>- Integrating domain knowledge in DL. <br> [[slides][L18a] \| [video][L18c] \| [notes][L18d]]	|   - Arjovsky, Bottou. [Towards principled methods for training generative adversarial networks][L18r1]. <br>- Kingma, Dhariwal. [Glow - Generative Flow with Invertible 1x1 Convolutions][L18r2]. <br>- Hu et al. [Harnessing Deep Neural Networks with Logic Rules][L18r3]. <br>- Hu et al. [Deep Generative Models with Learnable Knowledge Constraints][L18r4]. <br>	|
|   3/27 <br> Midway report due.	|   Lecture #19 (guest lecture, Zhiting Hu): <br>**Case Study: Text Generation.** <br>- The encoder-decoder framework <br>- Machine translation as conditional generation. <br>- Unifying MLE and RL objectives for text generation. <br> [[slides][L19a] \| [video][L19c] \| [notes][L19d]]	|   - Ranzato et al. [Sequence Level Training with Recurrent Neural Networks][L19r1]. <br>- Hu et al. [Toward Controlled Generation of Text][L19r2]. <br>- Tan, Hu et al. [Connecting the Dots Between MLE and RL for Sequence Generation][L19r3]. <br>	|
|   4/1	|   	Lecture #20 (Maruan): <br>**Sequential decision making (part 1): The framework.** <br>- Brief introduction to reinforcement learning (RL). <br>- Connections to GM: RL and control as inference. <br>- Control via Variational Inference. <br> [[slides][L20a] ([annotated][L20b]) \| [video][L20c] \| [notes][L20d]]	|  - Sutton, Barto, Reinforcement Learning, An Introduction, [Ch. 3][L20r1], [Ch. 4][L20r2]. <br>- Lilian Weng. [A peek into RL (blog)][L20r3]. <br>- Levine. [Reinforcement Learning and Control as Probabilistic Inference][L20r4], Sec. 1-3. <br>- Ziebart. [Modeling Purposeful Adaptive Behavior with the Principle of Maximum Causal Entropy][L20r5], Ch. 5.1-2, 6.1-2. <br>- Todorov. [General duality between optimal control and estimation][L20r6]. <br>- Koller and Friedman textbook, [Ch. 20.3][L20r7]. <br>	|
|   4/3 <br> HW3 due.	|   Lecture #21 (Maruan): <br>**Sequential decision making (part 2): The algorithms.** <br>- Intro to RL algorithms: policy gradients and Q-learning. <br>- Max-entropy policy gradient. <br>- Soft Q-learning. <br> [[slides][L21a] ([annotated][L21b]) \| [video][L21c] \| [notes][L21d]]	|   - Sutton, Barto. Reinforcement Learning, An Introduction, [Ch. 13][L21r1]. <br>- Levine. [Reinforcement Learning and Control as Probabilistic Inference][L21r2], Sec. 4. <br>- Harnoja et al. [Reinforcement Learning with Deep Energy-Based Policies][L21r3]. <br>- Haarnoja et al. [Soft Actor-Critic][L21r4]. <br>	|
|   4/8 <br> HW4 out.	|   Lecture #22 (Eric): <br> **Bayesian nonparametrics.** <br>- Dirichlet Process (DP). <br>- Indian Buffet Process (IBP). <br> [[slides][L22a] ([annotated][L22b]) \| [video][L22c] \| [notes][L22d]]	|   - Teh. [The Dirichlet Process][L22r1]. <br>- Griffiths and Ghahramani. [The Indian Buffet Process][L22r2]. <br>	|
|   4/10	|   Lecture #23 (Maruan): <br>**Bayesian non-parameterics (continued).** <br>- Inference in Dirichlet Process (DP). <br>- Hierarchical Dirichlet Process (HDP). <br>- Indian Buffet Process (IBP). <br> [[slides][L23a] \| [video][L23c] \| [notes][L23d]]	|   - [Notes on Dirichlet Processes][L23r1]. <br>- Ishwaran, James. [Gibbs Sampling Methods for Stick-Breaking Priors][L23r2]. <br>- Teh, Jordan, Beal, Blei. [Hierarchical Dirichlet Process][L23r3]. <br>	|
|   4/15	|   Lecture #24 (Eric): <br>**Integrative Paradigms of GM: Regularized Bayesian Methods.** <br> [[slides][L24a] ([annotated][L24b]) \| [video][L24c] \| [notes][L24d]]	|   - Ganchev, Graça, Gillenwater, Taskar. [Posterior Regularization for Structured Latent Variable Models][L24r1]. <br>- Zhu, Chen, Xing. [Bayesian Inference with Posterior Regularization and Applications to Infinite Latent SVMs][L24r2]. <br>	|
|   4/17	|   Lecture #25 (Eric): <br> **Elements of Spectral & Kernel GMs.** <br> [[slides][L25a] ([annotated][L25b]) \| [video][L25c] \| [notes][L25d]] |  - Le Song. [Learning via Hilbert space embedding of distributions][L25r1], Sec. 2.1, 2.2, 3.1, 3.2. <br>- Hsu, Kakade, Zhang. [A Spectral Algorithm for Learning Hidden Markov Models][L25r2]. <br>- Song, Liu, Parikh, Xing. [Nonparametric latent tree graphical models][L25r3]. <br>- Parikh, Song, Xing. [A Spectral Algorithm for Latent Tree Graphical Models][L25r4]. <br>	|
|   4/22	|   Lecture #26 (Maruan): <br>**Gaussian processes (GPs) and elements of meta-learning.** <br>- Gaussian Processes (GPs) and kernel functions. <br>- (Deep) kernel learning and approximations. <br>- Neural Processes (NPs) as an approximation to GPs. <br>- Elements of meta-learning. <br> [[slides][L26a] \| [video][L26c] \| [notes][L26d]]	|   - Rasmussen, Williams. Gaussian Processes for Machine Learning, [Ch. 2.2-2.4][L26r1], [Ch. 4.1-4.2][L26r2]. <br>- Görtler, Kehlbeck, Deussen. [A Visual Exploration of Gaussian Processes(blog)][L26r3]. <br>- Wilson, Hu, Salakhutdinov, Xing. [Deep Kernel Learning][L26r4]. <br>- Garnelo et al. [Conditional Neural Processes][L26r5]. <br>	|
|   4/24 <br> HW4 due.	|   Lecture #27 (guest lecture, Qirong Ho): <br> **Scalable algorithms and systems for learning, inference, and prediction.** <br> [[slides][L27a] \| [video][L27c] \| [notes][L27d]]	|   - Bradley et al. (2011). [Parallel Coordinate Descent for L1-Regularized Loss Minimization][L27r1]. <br>- Yuan et al. (2015). [LightLDA - Big Topic Models on Modest Computer Clusters][L27r2]. <br>- Ho et al. (2013). [More effective distributed ML via a stale synchronous parallel parameter server][L27r3]. <br>- Kim et al. (2016). [STRADS - A Distributed Framework for Scheduled Model Parallel Machine Learning][L27r4]. <br>	|
|   4/29	|   Lecture #28 (Eric): <br> **A civil engineering perspective on AI.** <br> [[slides][L28a] ([annotated][L28b]) \| [video][L28c] \| [notes][L28d]]	|   - Xing et al. [Petuum - A New Platform for Distributed Machine Learning on Big Data][L28r1]. <br>- Xing et al. [Strategies and Principles of Distributed Machine Learning on Big Data][L28r2]. <br>|
...
There are no official, publically available course solutions for the assignments. For those self-studying, please see the secion *"Additional comments on homework assignments"* in the 2nd part of this page.
...
* Probability - basic fluency is required. Fluency with manipulation of basic probability statements via application of probability rules is absolutely essential both to the exact inference and approxiamte inference parts of the course.
* Statistics - basic fluency is required. In particular, familarity in dealing with multivariate objects in a statisical setting e.g. computing expectations; and also familiarity with the notion of a statistic, maximum likelihood estimation. Familiarity with Bayesian statistics is *essential*.
...
On logistics, with the exception of lecture 5, "*Parameter learning in fully observable Bayesian Networks*", which was skipped in the course itself, the entire set of video lectures uploaded onto YouTube is *complete.*

On the technical side, there are *no issues* with audio discernibility nor with video clarity.

There are an alternative set of links for the video lectures, whose video quality is clearer, but not overly noticeably so, and these are hosted on a publically available part of CMU Panopto here:
...
Robert, C., Casella, G. (2010). *Monte Carlo Statistcal Methods (2nd ed.).* Springer-Verlag New York Inc.
...
[L1r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture01-readings/jordan-2004.pdf
[L1r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture01-readings/airolidi-2007.pdf
...
[L3r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture03-readings/fischer-igel-2012.pdf
...
[L4r5]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture04-readings/minka-2005.pdf
...
[L5r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture05-readings/geiger-heckerman-1997.pdf
[L5r5]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture05-readings/geiger-heckerman-2002.pdf
...
[L6r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture06-readings/borman-2006.pdf
[L6r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture06-readings/neal-hinton-1998.pdf
...
[L7r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture07-readings/friedman-hastie-tibshirani-2007.pdf
[L7r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture07-readings/lafferty-mccallum-pereira-2001.pdf
...
[L8r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture08-readings/zhang-scholkopf-spirtes-glymour-2017.pdf
...
[L9r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture09-readings/meinshausen-buhlmann-2006.pdf
[L9r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture09-readings/kolar-lesong-ahmed-xing-2010.pdf
[L9r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture09-readings/dempster-1972.pdf
...
[L10r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture10-readings/welch-bishop-2006.pdf
[L10r5]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture10-readings/wallach-2004.pdf
...
[L11r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture11-readings/yedidia-freedman-weiss-2000.pdf
[L11r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture11-readings/xing-jordan-russell-2012.pdf
[L11r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture11-readings/mohamed-blei-ranganath-2016.pdf
...
[L12r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture12-readings/wainwright-jordan-2003.pdf
[L12r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture12-readings/wainwright-jordan-monster-2008.pdf
...
[L14r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture14-readings/neal-2012.pdf
[L14r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture14-readings/patterson-teh-2013.pdf
...
[L15r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture15-readings/salakhutdinov-hinton-2009.pdf
[L15r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture15-readings/belanger-mccallum-2016.pdf
[L15r5]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture15-readings/ranganath-tang-charlin-blei-2015.pdf
...
[L16r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture16-readings/pascanu-mikolov-bengio-2013.pdf
[L16r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture16-readings/vaswani-et-al-2017.pdf
[L16r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture16-readings/devlin-chang-lee-toutonova-2019.pdf
...
[L17r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture17-readings/kingma-welling-2014.pdf
[L17r3]:https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture17-readings/goodfellow-et-al-2014.pdf
...
[L18r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture18-readings/arjovsky-bottou-2017.pdf
[L18r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture18-readings/kingma-dhariwal-2018.pdf
[L18r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture18-readings/hu-et-al-2020.pdf
[L18r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture18-readings/hu-et-al-2018.pdf
...
[L19r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture19-readings/ranzato-et-al-2016.pdf
[L19r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture19-readings/hu-et-al-2018.pdf
[L19r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture19-readings/tan-et-al-2019.pdf
...
[L20r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture20-readings/levine-2018.pdf
[L20r5]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture20-readings/ziebart-2010.pdf
[L20r6]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture20-readings/todorov-2008.pdf
...
[L21r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture21-readings/levine-2018.pdf
[L21r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture21-readings/haarnoja-tang-abbeel-levine-2017.pdf
[L21r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture21-readings/haarnjoa-zhou-abbeel-levine-2018.pdf
...
[L22r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture22-readings/teh.pdf
[L22r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture22-readings/griffiths-gharamani-2011.pdf
...
[L23r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture23-readings/ishwaran-2001.pdf
[L23r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture23-readings/teh-jordan-beal-blei-2005.pdf
...
[L24r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture24-readings/ganchev-graca-gillenwater-taskar-2010.pdf
[L24r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture24-readings/zhu-chen-xing-2014.pdf
...
[L25r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture25-readings/le-song-2008.pdf
[L25r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture25-readings/hsu-kakade-zhang-2012.pdf
[L25r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture25-readings/lesong-parikh-liu-xing-2014.pdf
[L25r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture25-readings/parikh-song-xing-2014.pdf
...
[L26r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture26-readings/wilson-hu-salakhutdinov-xing-2015.pdf
[L26r5]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture26-readings/garnelo-et-al-2018.pdf
...
[L27r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture27-readings/bradley-kryola-bickson-guestrin-2016.pdf
[L27r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture27-readings/yuan-et-al-2015.pdf
[L27r3]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture27-readings/ho-et-al-2013.pdf
[L27r4]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture27-readings/kim-et-al-2016.pdf
...
[L28r1]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture28-readings/xing-et-al-2015.pdf
[L28r2]: https://github.com/cyber-rhythms/cmu-10-708-probabilistic-graphical-models-spring-2019/blob/master/readings/lecture28-readings/xing-ho-xie-wei-2016.pdf
