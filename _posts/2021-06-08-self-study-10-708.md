...
|   1/23	|   Lecture #3 (Eric):<br> **Representation: Undirected GMs (MRFs).**<br> [[slides][L3a] ([annotated][L3b]) \| [video][L3c] \| [notes][L3d]]	|   - Jordan textbook, [Ch. 2][L3r1]. (Sec. 2.2 - end). <br>- Koller and Friedman textbook, [Ch. 4][L3r2]. <br> - A. Fischer and C. Igel. [An Introduction to Restricted Boltzmann Machines][L3r3]. <br>	|
